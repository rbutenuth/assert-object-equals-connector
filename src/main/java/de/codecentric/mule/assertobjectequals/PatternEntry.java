...
public class PatternEntry {
	...
	/**
	 * @param listIndex 0 or positive value: Count from beginning, negative value: count from end (-1 is last), <code>null</code>: match any list entry.
	 */
	...
	/**
	 * @return 0 or positive value: Count from beginning, negative value: count from end (-1 is last), <code>null</code>: match any list entry.
	 */
